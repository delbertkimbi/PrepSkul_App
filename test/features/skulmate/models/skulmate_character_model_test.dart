...
void main() {
  ...
  group('SkulMateCharacters Predefined Characters', () {
    ...
    test('should have Cameroonian names', () {
      expect(SkulMateCharacters.elementaryMale.name, 'Mbiya');
      expect(SkulMateCharacters.elementaryFemale.name, 'Nchia');
      expect(SkulMateCharacters.middleMale.name, 'Etonge');
      expect(SkulMateCharacters.middleFemale.name, 'Aseh');
      expect(SkulMateCharacters.highMale.name, 'Achu');
      expect(SkulMateCharacters.highFemale.name, 'Nde');
    });
    ...
    test('should have default character', () {
      ...
      expect(defaultChar.name, 'Etonge');
    });
  });
}
